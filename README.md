...
[![Category: Research](https://img.shields.io/badge/Category-Research-purple)](#)
...
cp -r research/arxiv ~/.hermes/skills/research/arxiv/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/arxiv-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/arxiv-skill.git ~/.hermes/skills/research/arxiv/
```
...
```text
Use the arxiv skill to <describe your specific task here>
```
...
```text
Gunakan skill arxiv untuk <deskripsikan tugas spesifik Anda di sini>
```
